          ...
          <div className="flex flex-col justify-between flex-1 mt-6">
            <nav className="flex-1 -mx-3 space-y-3 ">
              {user.role === "doctor" && (
                <>
                  <Link
                    className={`flex items-center px-3 py-2 text-gray-300 transition-colors duration-300 transform rounded-lg  ${
                      location.pathname === ""
                  ...
                  >
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3 3 0 016 0z"
                      />
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <div className="flex items-center justify-between mt-6">
                <a to="#" className="flex items-center gap-x-2">
                  {photoUrl ? (
                    <img
                      src={photoUrl}
                      className="rounded-full border-white border-2 w-11 h-11"
                      alt="profile-pic"
                    />
                  ) : (
