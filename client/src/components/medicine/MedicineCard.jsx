...
const MedicineCard = ({ medicineData, onAddToCart }) => {
    const {
        Id,
        name,
        description,
    ...
    return (
        <div className='flex flex-col justify-around rounded-[0.25rem] shadow-xl max-[1435px]:w-full h-[23rem] max-[400px]:h-auto'>
            ...
            <div className='px-4'>
                <p>Box Contains {Packaging}</p>
            </div>
            <div className='flex px-4 flex-wrap justify-between items-center'>
                <p className='text-sm'>Made by {manufactures}</p>
                <div>
