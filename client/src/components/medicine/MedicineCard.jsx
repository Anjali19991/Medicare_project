...
const MedicineCard = ({ medicineData, onAddToCart, isAddedToCart, setIsAddedToCart }) => {
    ...
    return (
        <>
            <div className='flex flex-col justify-around rounded-[0.25rem] shadow-xl max-[1435px]:w-full h-[24rem] max-[400px]:h-auto max-[400px]:gap-4 hover:scale-105 duration-300 transition-all'>
